 ...
 * @package App\Models
 */
class FilialRoomModel extends Model
{
    /**
     * @var \PDO
     */
    ...
    public function addRoomModel($data = null)
    {
        ...
        try {
            $con = $this->db;
            $sql = "INSERT INTO filial_rooms(room, name, number, department_id, filial_id, date_create) VALUES(true, :name, -1, :departament_id, :filial_id, (SELECT CURRENT_DATE))";
